...
public class StatsActivity extends ActionBarActivity {
    ...
    private static final String STATS_OVERALL_TAG = "overall stats fragment";
    ...
    private void setupFragments() {
        ...
        // Always display the overall stats, no matter the earCode.
        if(mFragmentManager.findFragmentByTag(STATS_OVERALL_TAG) == null) {
            ...
            transaction.add(R.id.stats_fragment_container, overallCategoryFrag, STATS_OVERALL_TAG);
        }

        // When earCode is both_ears, then display fragments for left and right ears.
        if(earCode == SharedPreferencesHelper.BOTH_EARS) {
    ...
    private String getReport() {
        ...
        BatteryStatsFragment statsFrag1 = (BatteryStatsFragment) mFragmentManager.findFragmentByTag(STATS_OVERALL_TAG);
        ...
        if(statsFrag2 != null) {
            report.append("\n")
                  .append(getString(R.string.report_left))
                  .append("\n")
        ...
        if(statsFrag3 != null) {
            report.append("\n")
                  .append(getString(R.string.report_right))
                  .append("\n")
